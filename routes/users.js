...
router.get('/',
  ...
  [
    ...
    query('role').optional().isIn(['admin', 'kasir', 'waiter', 'member', 'station', 'kitchen']),
...
router.put('/:id',
  ...
  [
    ...
    body('role').optional().isIn(['admin', 'kasir', 'waiter', 'member', 'station', 'kitchen']).withMessage('role must be admin, kasir, waiter, member, station, or kitchen'),
